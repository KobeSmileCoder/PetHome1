...
import com.example.sunhan.pethome1.util.AppManager;
import com.example.sunhan.pethome1.util.LogUtils;
import com.example.sunhan.pethome1.util.StatusBarUtil;

import java.util.List;

public abstract class BaseAvtivity extends FragmentActivity {
    protected Context context;
    protected BaseAvtivity activity;
